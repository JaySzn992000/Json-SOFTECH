...
try {
    ...
    // https://jsonsoftech.onrender.com/fetchCutomerOrder
const response = await fetch("https://jsonsoftech.onrender.com/fetchCutomerOrder");
...
try {
const response = await fetch("https://jsonsoftech.onrender.com/updateOrderStatus", {
method: "POST",
headers: {
